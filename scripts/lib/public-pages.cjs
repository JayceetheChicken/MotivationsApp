...
<html lang="de">
  <head>
    ...
    <!-- Framing and response-header protections live in public/_headers; CSP meta does not support frame-ancestors. -->
    <meta http-equiv="Content-Security-Policy" content="default-src 'none'; base-uri 'none'; form-action mailto:; img-src 'self' data:; script-src 'none'; style-src 'unsafe-inline'">
