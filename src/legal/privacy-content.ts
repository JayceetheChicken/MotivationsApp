...
export const privacySections: readonly LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Ein maschinenlesbarer JSON-Export des eigenen Online-Kontos kann in den Kontoeinstellungen erstellt und über das System-Teilen-Menü gespeichert werden. Er enthält eigene Profil-, Privacy-, Lern-, Gruppen-, Beziehungs-, Blockierungs- und Meldedaten, aber keine Tokens, Rate-Limits, internen Moderationsnotizen oder privaten Daten anderer Personen. Die App versucht, die temporäre Klartextdatei unmittelbar nach dem Teilen aus dem App-Cache zu entfernen. Schlägt dies fehl, zeigt sie den Fehler an und versucht die Bereinigung eindeutig benannter Exportdateien beim nächsten Export erneut.',
