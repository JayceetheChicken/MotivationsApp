...
function readImageHeader(input, imageOffset, fileLength) {
    if (!Number.isSafeInteger(imageOffset) || imageOffset < SIZE_HEADER ||
    ...
    if (!Number.isSafeInteger(imageLength) || imageLength < SIZE_HEADER ||
        imageOffset + imageLength > fileLength || imageOffset + imageLength > input.length) {
...
exports.ICNS = {
    ...
    calculate(input) {
        ...
        if (!Number.isSafeInteger(fileLength) || fileLength < SIZE_HEADER)
