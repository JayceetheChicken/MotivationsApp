...
function readBox(input, offset) {
    // An ISO BMFF box needs an eight-byte size/name header. A declared size of
    // zero means "through end of file"; normalizing that value here keeps every
    // caller's cursor strictly monotonic, including matching JXL/HEIF boxes.
    ...
    if (!Number.isSafeInteger(boxSize) || boxSize < 8)
        return;
